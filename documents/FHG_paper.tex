...
\begin{center}
\includegraphics[,trim={0 0 0 10cm}, clip, width=0.3\textwidth]{empty_spiral.pdf}
\end{center}
and will produce smooth trajectories like the curved line that appears in this
picture:
\begin{center}
\includegraphics[,trim={0 0 0 10cm}, clip, width=0.3\textwidth]{smooth_spiral_bare.pdf}
\end{center}
...
\begin{center}
\includegraphics[,trim={0 0 0 10cm}, clip, width=0.3\textwidth]{cells_spiral2.pdf}
\end{center}
...
\begin{center}
\includegraphics[,trim={0 0 0 10cm}, clip, width=0.3\textwidth]{spiral_bline.pdf}
\end{center}
...
picture:
\begin{center}
\includegraphics[,trim={0 0 0 10cm}, clip, width=0.3\textwidth]{spiral_safe3.pdf}
\end{center}
...
\begin{center}
\includegraphics[,trim={0 5cm 0 17cm}, clip, width=0.3\textwidth]{bezier_example3.pdf}
\end{center}
