...
predicate taken from the work of Knuth \cite{AxiomAndHulls}.
...
\cite{GeuversWZ02}.  The Mathematical Components library also contains
descriptions of procedures to descide problems with polynomials
\cite{CohenMahboubi11,CohenQERCF}.
