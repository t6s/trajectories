...
\end{frame}
\begin{frame}
\frametitle{The basics of quadratic Bézier curves}
\begin{itemize}
...
\begin{itemize}
\item The dashed line after does not make it possible to conclude
\item The solid lines do
\end{itemize}
\includegraphics[trim={0 4cm 0 17cm}, clip, width=\textwidth]{repair2.pdf}
\end{frame}
\begin{frame}
\frametitle{Proof difficulties}
\begin{itemize}
\item Reasoning about convex hulls of Bezier control points is a powerful tool
\item Question remains: how to reduce the amount of triangle tests
\end{itemize}
\end{frame}
