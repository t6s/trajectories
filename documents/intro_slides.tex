...
\item Collision between two segments
\end{itemize}
\item Convex spaces and Bezier Curve
\begin{itemize}
\item Internship by Q. Vermande
\item Using {\tt infotheo} (Affeldt et al.), {\tt mathcomp-analysis}
   (Cohen et al.)
\end{itemize}
...
\item Formal proof not yet done
\end{itemize}
\item work in progress
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Obtain triangles that are hug the curve enough
\end{itemize}
\item In the proof, dichotomy at the exact value
\begin{itemize}
\item Makes it easy to prove that the door is crossed only once
\end{itemize}
\end{itemize}
\end{frame}
\begin{frame}
